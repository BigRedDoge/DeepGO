...
from csgo_gsi.gamestate import GameState
from csgo_gsi.payloadparser import PayloadParser
...
class GSIServer(HTTPServer):
    ...
    def stop_server(self):
        self.server_close()
        print("CS:GO GSI Server stopped.")

    def get_info(self, target=None, *argv):
        try:
            if target is None:
